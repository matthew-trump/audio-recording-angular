...
@Component({
  selector: 'app-simple-playback-hark',
  templateUrl: './simple-playback-hark.component.html',
  styleUrls: ['./simple-playback-hark.component.scss']
})
export class SimplePlaybackHarkComponent implements OnInit {
